...
class HikvisionClient:
    ...
    def search_events(
        ...
        import uuid
        final_search_id = search_id if search_id else str(uuid.uuid4())
        ...
        # We default to 5 (Access Event) and 0 (All minor events).
        acs_event_cond = {
            "searchID": final_search_id,
            "searchResultPosition": position,
            "maxResults": page_size,
            "major": major_event if major_event > 0 else 5,
            "minor": minor_event if minor_event > 0 else 0,
            "startTime": start_str,
            "endTime": end_str,
        }
